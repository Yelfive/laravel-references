...
namespace Illuminate\Support\Facades {
    ...
    class Cookie
    {
         ...
         *
         * @return string
         * @see \Illuminate\Support\Facades\Cookie::getFacadeAccessor()
         */
         ...
         * @param bool $secure
         * @return array
         * @see \Illuminate\Cookie\CookieJar::getPathAndDomain()
         */
        protected static function getPathAndDomain($path, $domain, $secure = false)
        {
        }
