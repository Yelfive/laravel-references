...
namespace Illuminate\Support\Facades {
    ...
    class Bus
    {
         ...
         *
         * @return string
         * @see \Illuminate\Support\Facades\Bus::getFacadeAccessor()
         */
         ...
         * @param mixed $command
         * @return bool
         * @see \Illuminate\Bus\Dispatcher::commandShouldBeQueued()
         */
        protected static function commandShouldBeQueued($command)
        {
        }
         ...
         */
        protected static function pushCommandToQueue($queue, $command)
        {
        }
